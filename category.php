    ...
    <div class="container">
        <div class="row">
            ...
            <div class="post-container">
                ...
                $result1 = mysqli_query($conn, $sql1) or die("query not fier");
            ...
            <h2 class="page-heading"><?php echo $row1['category_name'];  ?></h2>
                ...
                $offset = ($page - 1) * $limit;
                $sql = "SELECT post.post_id,post.title,post.description,category.category_id,category.category_name 
                AS category,post.post_date,post.post_img,user.user_id,user.username AS author
